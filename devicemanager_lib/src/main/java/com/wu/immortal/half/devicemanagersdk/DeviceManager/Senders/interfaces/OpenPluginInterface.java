...
// Source File Name:   OpenPluginInterface.java
...
public interface OpenPluginInterface
{
	...
	public abstract void openPluginDevice(Context context, DeviceEnum deviceenum, UsbSerialPort usbserialport, OperationPluginCallBack operationplugincallback);
